...
namespace Luna.InputSystem
{
    ...
    ""controlSchemes"": [
        ...
        ~@ThirdPersonInput()
        {
            Debug.Assert(!m_Gameplay.enabled, "This will cause a leak and performance issues, ThirdPersonInput.Gameplay.Disable() has not been called.");
            Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, ThirdPersonInput.UI.Disable() has not been called.");
        }
