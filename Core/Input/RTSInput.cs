...
public partial class @RTSInput: IInputActionCollection2, IDisposable
{
    ...
    ~@RTSInput()
    {
        Debug.Assert(!m_Gameplay.enabled, "This will cause a leak and performance issues, RTSInput.Gameplay.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, RTSInput.UI.Disable() has not been called.");
    }
